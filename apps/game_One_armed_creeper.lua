...
local function initStaticData()
    local pre_symbols = {
        { "fish", 5, "Фугу" },
        { "cookie", 6, "Печенье" },
        { "quartz", 7, "Кристалл истинного кварца" },
        { "emerald", 8, "Изумруд" },
        { "crystal", 9, "Лазутроновый кристалл" },
        { "golden_apple", 12, "Золотое яблоко" },
        { "diamond", 14, "Алмаз" },
        { "uu_matter", 18, "Материя" },
        { "creeper", 20, "Голова крипера" }
    }
    ...
    for i = 1, #pre_symbols do
        ...
        local downloadUrl = "https://raw.githubusercontent.com/salimAbdulIt/OpenComputers-Casino/master/resources/images/one_armed_creeper/" .. pre_symbols[i][1] .. ".pic"
